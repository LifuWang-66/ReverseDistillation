...
def train(_class_, pars):
    ...
    train_path = 'C:/Users/lifuw/Desktop/Projects/anomaly_detection/Revisiting-Reverse-Distillation/content/' + _class_ + '/train'
    ...
    if _class_ in ['bottle']:
        num_epoch = 200
    if _class_ in ['zhongxuegao','zhongxuegao_test']:
        num_epoch = 20
    if _class_ in ['cube_sugar']:
        num_epoch = 50
    if _class_ in ['hezhuang']:
        num_epoch = 50
